...
struct SettingsView: View {
    ...
    @AppStorage("trustUnknownLinks") var trustUnknownLinks = false
    @AppStorage("useBiometrics") var useBiometrics = false
    @AppStorage("discordWebhookURL") var discordWebhookURL = ""
    @AppStorage("logLoginLogout") var logLoginLogout = true
    @AppStorage("logThemeChanges") var logThemeChanges = true
    @AppStorage("logSettingsChanges") var logSettingsChanges = true
    ...
    @State private var themeToDelete: ThemeModel? = nil
